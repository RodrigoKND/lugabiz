...
-Eventos y actividades próximas
-Nuevos Lugares
-Ofertas y Promociones
-Explora por ubicación
-Itinerarios sugeridos
-Apto para Fines de Semana
-Imperdibles del mes
-Lo más destacado por la comunidad
-Lugares con temáticas
-Lugares Elegantes
-Lugares para negocios
-Lugares para cumpleaños
-Experiencias únicas
-Mi lista
*/
const sections = [
        ...
        places: [
            {
                ...
                image: "https://tse2.mm.bing.net/th?id=OIP.VvgMZJsSOX_NzDqlX2jVlgHaEK&pid=Api",
                location: "Avenida América, Cochabamba",
                description: "Nuevo centro empresarial que ofrece espacios modernos para negocios y comercio."
            },
            {
                title: "Restaurante 'Sabores de Cochabamba'",
                image: "https://tse1.mm.bing.net/th?id=OIP.AGrEJIpOhIvOYZMN41E2MgHaEK&pid=Api",
                location: "Calle España #123, Cochabamba",
                description: "Nuevo restaurante que ofrece una fusión de cocina tradicional y contemporánea."
            },
            {
                title: "Parque Ecológico 'La Llajta'",
                image: "https://tse4.mm.bing.net/th?id=OIP.gWnqZ2VLgR5I_h4vysHZrAHaE8&pid=Api",
                location: "Zona norte, Cochabamba",
                description: "Reciente inauguración de un espacio verde dedicado a la conservación y recreación."
            },
            {
                title: "Galería de Arte 'ArteCocha'",
                image: "https://tse2.mm.bing.net/th?id=OIP.QwybOgIzI8vmxLIXhr4XUwHaE7&pid=Api",
                location: "Avenida Pando #456, Cochabamba",
                description: "Nueva galería que exhibe obras de artistas locales emergentes."
            }
        ],
        link: "/new-places"
    },
        ...
        places: [
            {
                ...
                image: "https://tse4.mm.bing.net/th?id=OIP.RjR4UBVXAkcVQtZ4FP8SVgHaEK&pid=Api",
                location: "Calle Buenos Aires #543, Cochabamba",
                description: "Promoción del 20% de descuento en estadías durante noviembre."
            },
            {
                title: "2x1 en entradas al Teleférico",
                image: "https://tse3.mm.bing.net/th?id=OIP.xmfM3bDWBbn3syldOkrBJwHaEK&pid=Api",
                location: "Cerro San Pedro, Cochabamba",
                description: "Oferta especial de dos entradas al precio de una durante los fines de semana de noviembre."
            },
            {
                title: "Promoción en Restaurante 'La Estancia'",
                image: "https://tse1.mm.bing.net/th?id=OIP.aH0DhJYZDthcDBw9NcB6OAHaE7&pid=Api",
                location: "Avenida América #789, Cochabamba",
                description: "Menú ejecutivo con un 15% de descuento de lunes a viernes."
            },
            {
                title: "Ofertas en Tienda de Artesanías 'Manos de Bolivia'",
                image: "https://tse3.mm.bing.net/th?id=OIP.Ka_wlRAU1IcNL0G6HgF6egHaHa&pid=Api",
                location: "Calle España #321, Cochabamba",
                description: "Descuentos del 10% en productos seleccionados durante noviembre."
            }
        ],
        link: "/promotions"
    },
        ...
        places: [
            {
                ...
                image: "https://www.tripadvisor.com/Hotel_Review-g297315-d1006026-Reviews-Hotel_Cochabamba-Cochabamba_Cochabamba_Department.html",
                location: "Avenida Ballivián #123, Cochabamba",
                description: "Un hotel de lujo con instalaciones de primera y un restaurante exclusivo."
            },
            {
                title: "Restaurante Gourmet 'El Portal'",
                image: "https://www.tripadvisor.com/Restaurant_Review-g297315-d2336725-Reviews-El_Portal-Cochabamba_Cochabamba_Department.html",
                location: "Avenida América Oeste #456, Cochabamba",
                description: "Restaurante de alta cocina conocido por su exquisita carta y ambiente elegante."
            },
            {
                title: "Casa de Campo",
                image: "https://www.tripadvisor.com/Restaurant_Review-g297315-d3400973-Reviews-Casa_de_Campo-Cochabamba_Cochabamba_Department.html",
                location: "Zona Norte, Cochabamba",
                description: "Un lugar exclusivo para eventos sociales con arquitectura colonial."
            },
            {
                title: "Café París",
                image: "https://www.tripadvisor.com/Restaurant_Review-g297315-d10090758-Reviews-Cafe_Paris-Cochabamba_Cochabamba_Department.html",
                location: "Plaza 14 de Septiembre, Cochabamba",
                description: "Cafetería con un diseño clásico francés, ideal para reuniones elegantes."
            }
        ],
        link: "/elegant-places"
    },
        ...
        places: [
            {
                ...
                description: "Moderno centro empresarial con espacios de coworking y oficinas privadas."
            },
            {
                title: "Café Work",
                image: "https://example.com/image2.jpg",
                location: "Avenida América #234, Cochabamba",
                description: "Un café con espacios dedicados para reuniones de negocios y trabajo remoto."
            },
            {
            ...
            },
            {
                ...
                description: "Centro con instalaciones para eventos corporativos y conferencias."
            }
        ],
        ...
        places: [
            {
                ...
                location: "Zona Sur, Cochabamba",
                description: "Centro de trampolines ideal para fiestas de cumpleaños infantiles."
            },
            {
                title: "Restaurante 'El Molino'",
                image: "https://example.com/image6.jpg",
                location: "Avenida Pando, Cochabamba",
                description: "Restaurante con espacios privados para celebrar eventos especiales."
            },
            {
                title: "Salón de Eventos 'Infinity'",
                image: "https://example.com/image7.jpg",
                location: "Zona Norte, Cochabamba",
                description: "Un lugar elegante para fiestas de cumpleaños y eventos familiares."
            },
            {
                title: "Parque de Diversiones Aventura",
                image: "https://example.com/image8.jpg",
                location: "Cercado, Cochabamba",
                description: "Parque temático con juegos y espacios para celebrar cumpleaños."
            }
        ],
        ...
        places: [
            {
                ...
                description: "Una experiencia inolvidable con vistas espectaculares desde el cielo."
            },
            {
            ...
            },
            {
                ...
                description: "Santuario para mariposas y aves exóticas, perfecto para los amantes de la naturaleza."
            },
            {
                title: "Camping en el Parque Tunari",
                image: "https://example.com/image12.jpg",
                location: "Cercanías de Cochabamba",
                description: "Disfruta de una noche bajo las estrellas en este parque natural."
            }
        ],
        link: "/unique-places"
    },
        ...
        <>
            {
                sections.map((section, index) => (
                    <section key={index} className="mb-5">
                        <h4 className="text-purple mt-4 mb-3 fw-bolder mx-5">
                            {section.section}
                        </h4>
                        <div className="d-flex flex-wrap justify-content-center gap-4">
                            {
                                section.places.map((place, index) => (
                                    <Card key={index} title={place.location} body={place.description}
                                        href={place.image} />
                                ))
                            }
                        </div>
