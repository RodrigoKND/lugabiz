...
function PlaceDetail() {
  ...
  const filtered = useMemo(() => {
    return placeUser?.filter((place) => {
      const route = place.location.concat(place.name).replaceAll(" ", "_");
      return route === id;
    });
  });
  const [data] = filtered;
  return (
    <section className="p-5">
      <div className="d-flex justify-content-end">
        <a
          href="https://api.whatsapp.com/send?text=¡Mira este post! https://Lugabiz.bo/post/123"
      ...
      <div className="row gx-4 gy-3">
        ...
        <div className="col-md-5">
          ...
          <div className="mt-2 mb-4 w-max">
            <Link
              to="/profile"
              target="_blank"
              className="mb-3 text-dark text-decoration-none cursor-pointer"
            >
              <img
            ...
            <div className="d-flex align-items-center">
              ...
              <span className="ml-1 text-sm">
                {`${
                  data?.priceFrom !== 0
                    ? `Bs. ${data?.priceFrom} -`
                    : "No se estableció un precio"
                } ${data?.priceTo ? `${data?.priceTo}` : " "}`}
              </span>
            </div>
            <div className="d-flex align-items-center">
              {/*TODO: FALTA ICONOS*/}
          ...
          <div className="p-3 border">
            ...
            <ul className="list-group text-sm mb-2">
              <li className="list-group-item border border-0">
                ...
                {data?.openTime.substring(0, 5)} -{" "}
                {data?.closeTime.substring(0, 5)}
              </li>
            </ul>
            <button className="cursor-pointer border border-0 p-2 rounded bg-tomato text-white w-100">
      ...
      {contentNav === "detalles" ? (
        ...
        contentNav === "comentarios" && (
          <>
            ...
            <div
              className="shadow-lg p-4 rounded-4 overflow-y-auto d-flex flex-column gap-3 position-relative"
              style={{ height: "25em" }}
            >
              ...
              <div className="position-sticky bg-white p-3 shadow-lg bottom-0 end-0 start-0">
                ...
                ></textarea>
                <button
                  className="btn text-white mt-3 rounded-pill"
                  style={{ background: "#229289" }}
                >
                  Enviar Comentario
                </button>
              </div>
      ...
      <div className="d-flex flex-wrap gap-4">
        <Card
          title="Avenida América Esquina Libertador"
          body="Hermoso lugar con suculenta comida"
          href="https://www.infodiez.com/wp-content/uploads/2019/09/Platostipicosdecochabamba_infodiez-1000x600.jpg"
        />
        <Card
          title="Avenida América Oeste Esquina Portales"
          body="Fundación Patiño para visitar y pasar el rato"
          href="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTZs7mGaUKlPV0Lx8fWo6cpBQJT2NhJCHQF2w&s"
        />
        <Card
          title="Avenida América Esquina Libertador"
          body="Hermoso lugar con suculenta comida"
